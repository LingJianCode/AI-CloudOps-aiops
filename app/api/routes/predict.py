...
async def predict_qps(
    ...
    try:
        ...
        if req.enable_ai_insights:
            prediction_result = await (await get_prediction_service()).predict_with_ai_analysis(
                prediction_type="qps",
...
async def predict_cpu(
    ...
    try:
        ...
        if request.enable_ai_insights:
            ...
            prediction_result = await (await get_prediction_service()).predict_cpu_utilization(
...
async def predict_memory(
    ...
    try:
        ...
        if request.enable_ai_insights:
            ...
            prediction_result = await (await get_prediction_service()).predict_memory_utilization(
...
async def predict_disk(
    ...
    try:
        ...
        if request.enable_ai_insights:
            ...
            prediction_result = await (await get_prediction_service()).predict_disk_utilization(
...
async def prediction_health() -> Dict[str, Any]:
    ...
    try:
        await (await get_prediction_service()).initialize()
        health_info = await (await get_prediction_service()).get_service_health_info()
