...
# RAG 助手常量 - 优化后的配置
DEFAULT_TOP_K = 8  # 增加检索数量，提高召回率
MAX_CONTEXT_LENGTH = 6000  # 增加上下文长度
SIMILARITY_THRESHOLD = 0.05  # 大幅降低相似度阈值，提高召回率
MAX_HISTORY_LENGTH = 20
HALLUCINATION_COVERAGE_THRESHOLD = 0.3
DEFAULT_MAX_CONTEXT_DOCS = 8  # 增加默认上下文文档数
MIN_RELEVANCE_SCORE = 0.3  # 降低最小相关性分数

# 助手性能常量 - 优化配置
ASSISTANT_PERFORMANCE_METRICS_MAX_SAMPLES = 100
ASSISTANT_DEFAULT_VECTOR_DIM = 1536
ASSISTANT_INIT_SLEEP_INTERVAL = 0.1
ASSISTANT_MANAGER_WAIT_CYCLES = 10  # 减少等待周期
ASSISTANT_MANAGER_SLEEP_INTERVAL = 0.2  # 减少睡眠间隔
ASSISTANT_SESSION_HISTORY_MAX_LENGTH = 6  # 增加会话历史长度
ASSISTANT_ANSWER_TRUNCATE_LENGTH = 100  # 增加答案截断长度
ASSISTANT_RELEVANCE_CACHE_THRESHOLD = 0.3  # 大幅降低缓存阈值，提高缓存命中率
ASSISTANT_CACHE_TTL_SECONDS = 3600  # 增加缓存时间到1小时
ASSISTANT_DEFAULT_MAX_CONTEXT_DOCS = 6  # 提高默认上下文文档数
